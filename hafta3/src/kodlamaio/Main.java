...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				student1.getId() + " Numaralý Kullanýcýnýn Kodu : " + student1.getCode() + " Olarak Atanmýþtýr.");
		...
		System.out.println(
				student2.getId() + " Numaralý Kullanýcýnýn Kodu : " + student2.getCode() + " Olarak Atanmýþtýr.");
		...
		System.out.println(
				instructor1.getId() + " Numaralý Kullanýcýnýn Kodu : " + instructor1.getCode() + " Olarak Atanmýþtýr.");
		...
		System.out.println(
				instructor2.getId() + " Numaralý Kullanýcýnýn Kodu : " + instructor2.getCode() + " Olarak Atanmýþtýr.");

		System.out.println("-----------------------------------------");

		User[] users = new User[] { new User(), new Student(), new Instructor() };
